...
const PenaltyAppealModal = ({ isOpen, onClose, penaltyId, penaltyReason, onAppealSubmitted }: PenaltyAppealModalProps) => {
  const { user } = useAuth();
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      toast.success('Đã gửi kháng cáo! Admin sẽ xem xét trong 3-5 ngày làm việc.');
      onAppealSubmitted();
      onClose();
    } catch (error: any) {
      ...
      <DialogContent className="max-w-md">
        ...
        <div className="space-y-4">
          ...
          <div className="bg-red-50 border border-red-200 rounded-lg p-3">
            <h4 className="font-medium text-red-900 mb-1">Hình phạt hiện tại:</h4>
            ...
            <div className="flex">
              ...
              <div className="text-xs text-yellow-800">
                ...
                <ul className="space-y-0.5">
                  ...
                  <li>• Kháng cáo sai sự thật có thể dẫn đến hình phạt nặng hơn</li>
                  <li>• Admin sẽ xem xét trong 3-5 ngày làm việc</li>
                  <li>• Cung cấp bằng chứng rõ ràng để tăng cơ hội thành công</li>
                </ul>
              </div>
            </div>
          </div>
