...
import { Eye, EyeOff, Mail, Phone, AlertTriangle, CheckCircle } from 'lucide-react';
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Đăng nhập vào SABO Pool Arena để tham gia cộng đồng billiards lớn nhất Việt Nam" />
      </Helmet>
