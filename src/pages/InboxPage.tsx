...
const InboxPage = () => {
  ...
  const getCurrentNotifications = () => {
    ...
    if (searchQuery) {
      currentList = currentList.filter(notification => 
          ...
          <div className="mb-6">
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h1 className="text-3xl font-bold text-gray-900">Hộp thư thông minh</h1>
                  <p className="text-gray-600 mt-1">Quản lý tin nhắn và thông báo một cách hiệu quả</p>
                </div>
              </div>
                  ...
                  <ScrollArea className="h-[600px]">
                    {loading ? (
                      ...
                      <div className="text-center py-12 text-gray-500">
                        ...
                        <p className="text-lg font-medium mb-2">Không có tin nhắn</p>
                        <p className="text-sm">
                          {activeTab === 'unread' && 'Bạn đã đọc tất cả tin nhắn!'}
                ...
                {selectedMessage ? (
                        ...
                        <div className="prose max-w-none">
                          ...
                          {selectedMessage.metadata && Object.keys(selectedMessage.metadata).length > 0 && (
                            <div className="bg-gray-50 rounded-lg p-4 mb-6">
                              <h4 className="font-medium mb-3 text-gray-900">Chi tiết bổ sung</h4>
                  ...
                  <CardContent className="flex items-center justify-center h-full">
                    <div className="text-center text-gray-500">
                      ...
                      <h3 className="text-xl font-medium mb-3">Chọn một tin nhắn</h3>
